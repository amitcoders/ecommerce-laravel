                ...
                <div class="row">
                    <div class="col-lg-8 col-md-6">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="checkout__input">
                                    <p>Phone<span>*</span></p>
                                    <input type="text" name="shipping_phone" value="<?php echo e(Auth::user()->phone); ?>">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="checkout__input">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="checkout__order">
                            ...
                            <div class="checkout__order__total">Total <span><?php echo e($subtotal - session()->get('coupon')['discount_amount']); ?></span></div>
                            <?php else: ?>
                            <div class="checkout__order__subtotal">sub total <span>$<?php echo e($subtotal); ?></span></div>
...
<?php echo $__env->make('layouts.front_end_index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ecommerce-laravel\resources\views/pages/checkout.blade.php ENDPATH**/ ?>