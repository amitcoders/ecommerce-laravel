...
<html lang="en">
  <head>
    ...
    <!-- Twitter -->
    <link rel="icon" type="image/png" sizes="32x32" href="<?php echo e(asset('backend/img/img1.jpg')); ?>">
    ...
    <link href="<?php echo e(asset('backend/lib/rickshaw/rickshaw.min.css')); ?>" rel="stylesheet">
     ...
     <link href="<?php echo e(asset('backend/lib/highlightjs/github.css')); ?>" rel="stylesheet">
  ...
  <body>
    ...
    <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
        <a href="<?php echo e(route('admin.home')); ?>" class="sl-menu-link active">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon ion-ios-home-outline tx-22"></i>
            <span class="menu-item-label">Dashboard</span>
          </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
        <a href="<?php echo e(route('site.index')); ?>" target="_blank" class="sl-menu-link">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon ion-ios-photos-outline tx-20"></i>
            <span class="menu-item-label">Visit Website</span>
          </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
        <a href="<?php echo e(route('admin.category')); ?>" target="_blank" class="sl-menu-link">
            <div class="sl-menu-item">
              <i class="menu-item-icon icon ion-ios-photos-outline tx-20"></i>
        ...
        <a href="<?php echo e(route('admin.brand')); ?>" target="_blank" class="sl-menu-link">
            <div class="sl-menu-item">
              <i class="menu-item-icon icon ion-ios-photos-outline tx-20"></i>
              <span class="menu-item-label">Brand</span>
            </div><!-- menu-item -->
          </a><!-- sl-menu-link -->
        <a href="<?php echo e(route('admin.category')); ?>" class="sl-menu-link">
          <div class="sl-menu-item">
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="<?php echo e(route('add.products')); ?>" class="nav-link">Add Products</a></li>
          <li class="nav-item"><a href="<?php echo e(route('manage-products')); ?>" class="nav-link">Manage Products</a></li>
          
        </ul>
        <a href="<?php echo e(route('admin.coupon')); ?>" class="sl-menu-link">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon ion-ios-gear-outline tx-24"></i>
            <span class="menu-item-label">Coupoun</span>
          </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
        <a href="#" class="sl-menu-link">
          <div class="sl-menu-item">
        ...
        <nav class="nav">
          <div class="dropdown">
            <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
              ...
              <img src="<?php echo e(asset('backend/img/img3.jpg')); ?>" class="wd-32 rounded-circle" alt="">
            </a>
...
<?php /**PATH C:\xampp\htdocs\ecommerce-laravel\resources\views\admin\admin_layouts.blade.php ENDPATH**/ ?>