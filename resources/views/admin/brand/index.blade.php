            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            @foreach($brands as $amit)
                                <td>{{$amit->id}}</td>
                                <td>{{$amit->brand_name}}</td>
                               <td>@if ($amit->status == 1)
                            ...
                            <td>
                                    <a href="{{ route('brand.edit', $amit->id)}}" class="btn btn-success">Edit</a>
                                    <a href="{{ route('brand.delete',$amit->id)}}" class="btn btn-danger">Delete</a>

                                    @if ($amit->status == 1)
                                        <a class="btn btn-info" href="{{ route('brand.inactive',$amit->id)}}">Active</a>
                                    @else
                                        <a class="btn btn-primary" href="{{ route('brand.active',$amit->id)}}">Inactive</a>
                                    @endif
                                </td>
