...
<html lang="en">
  <head>
    ...
    <!-- Twitter -->
    <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('backend/img/img1.jpg')}}">
  ...
  <body>
    ...
    <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
        ...
        <a href="{{ route('site.index')}}" target="_blank" class="sl-menu-link">
          <div class="sl-menu-item">
        ...
        <a href="{{ route('admin.brand')}}" target="_blank" class="sl-menu-link">
            <div class="sl-menu-item">
              <i class="menu-item-icon icon ion-ios-photos-outline tx-20"></i>
        ...
        <a href="{{ route('add.products')}}" class="sl-menu-link">
          <div class="sl-menu-item">
            <i class="menu-item-icon ion-ios-pie-outline tx-20"></i>
